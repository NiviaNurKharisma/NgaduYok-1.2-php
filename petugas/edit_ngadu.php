          ...
          <div class="card">
            ...
            ?>
              <form action=""  method="POST" >
                <h6 class="heading-small text-muted mb-4">Verifikasi Pengaduan</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                    <label class="form-control-label">Verifikasi</label>
                    <td>
                ...
                <input type="submit" name="ngadu_submit" value="Verifikasi!" class = 'btn btn-success btn-sm'>
