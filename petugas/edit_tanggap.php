          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <?php
                    ...
                    $submit = isset($_POST['tanggap_submit'])?$_POST["tanggap_submit"]:"";
                        if ($submit) {
              ...
              <form action=""  method="POST" >
                ...
                <div class="row">
                  <div class="col-lg-6">
                    ...
                    <td>
                    <textarea name="tanggapan" rows="4" class="form-control"><?=$row['tanggapan'];?></textarea>
                    </td>
                    </div>
                  </div>
                </div>
                ...
                <input type="submit" name="tanggap_submit" value="Edit" class = 'btn btn-success btn-sm'>
