        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Verval</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="index.php"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="selengapnya.php">Validasi</a></li>
                        ...
                        while($row = $result->fetch_assoc() ) //menampilkan bentuk array
                        {
                          ...
                          if($row["status"] == "0") $status = "belum";
                            ...
                            <tr>
                                ...
                                <td>".$status."</td>
                                <td>
                                <a href= 'tanggapi.php?id=".$row["id_pengaduan"].
                                "'class = 'btn btn-success btn-sm'>Tanggapi</a>
