        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Verifikasi Pengaduan</h6>
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="#" class="btn btn-sm btn-neutral">PDF</a>
              <a href="#" class="btn btn-sm btn-neutral">Excel</a>
            </div>
          </div>
        </div>
      </div>
                    ...
                    <?php
                        ...
                        while($row = $result->fetch_assoc() ) //menampilkan bentuk array
                        {
                            ...
                            <tr>
                                ...
                                <td>".$row["status"]."</td>
                                <td>
                                <a href= 'detail_ngadu.php?id=".$row["id_pengaduan"].
                                "'class = 'btn btn-success btn-sm'>Detail</a>
                                |
                                <a href= 'tanggapan.php?id=".$row["id_pengaduan"]."'
                                onclick='return confirm (\"Are you sure want to delete?\");'
                                class = 'btn btn-danger btn-sm'>Tanggapi</a>
                            </td>
                        </tr>
                        "; 
                        $no++;   
