            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
                ...
                <div class="list-group list-group-flush">
                  <a href="viewngadu.php" class="list-group-item list-group-item-action">
                  ...
                  <a href="viewtanggap.php" class="list-group-item list-group-item-action">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <!-- Avatar -->
                        <i class="ni ni-bullet-list-67"></i>
    ...
    <div class="header bg-primary pb-6">
      <div class="container-fluid">
        <div class="header-body">
          ...
          <?php
            $semua = $database->query("SELECT COUNT(id_pengaduan) FROM pengaduan");
            $selesai = $database->query("SELECT COUNT(id_pengaduan) FROM pengaduan WHERE `status`='selesai'");
            $proses = $database->query("SELECT COUNT(id_pengaduan) FROM pengaduan WHERE `status`='proses'");
            $belum = $database->query("SELECT COUNT(id_pengaduan) FROM pengaduan WHERE `status`='0'");
          ?>
          <!-- Card stats -->
          <div class="row">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?php echo $semua->fetch_array()[0]?></span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Belum</h5>
                      <span class="h2 font-weight-bold mb-0"><?php echo $belum->fetch_array()[0]?></span>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Proses</h5>
                      <span class="h2 font-weight-bold mb-0"><?php echo $proses->fetch_array()[0]?></span>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0"><?php echo $selesai->fetch_array()[0]?></span>
                    </div>
                    <div class="col-auto">
