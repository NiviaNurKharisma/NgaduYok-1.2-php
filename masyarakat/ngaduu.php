      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="ngaduu.php">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            ...
            <p class="text-white mt-0 mb-5">Terimakasih sudah membuat laporan perihal kerusakan lingkungan yang terjadi di Kel Karanganyar Subang</p>
            <a href="#lapor" class="btn btn-neutral">Laporan Kamu</a>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="../../pengaduan/resources/img/profil3.jpg" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
              ...
              <form action="" enctype="multipart/form-data" method="POST" >
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="lokasi" rows="3" class="form-control" placeholder="terjadi di..." required></textarea>
                      </div>
                ...
                <div class="pl-lg-4">
                  <div class="form-group">
                    ...
                    <textarea name="isi_laporan" rows="4" class="form-control" placeholder="....." required></textarea>
                  </div>
                </div>

                <input type="submit" name="ngadu_submit" value="Kirim" class="btn btn-sm btn-primary"/>
